...
<p><b>Imagen eco simulada.</b> Las mallas se convierten en un volumen de tejidos de 1 mm (miocardio, cavidades, válvulas, grandes vasos, pericardio, costillas) y un volumen torácico de 2,5 mm. Pulmón, hígado, diafragma y la vena cava inferior abdominal con las venas suprahepáticas son aproximaciones propias, porque el atlas no los incluye. El esternón y el xifoides se tratan como cartílago con núcleos de osificación, como en el niño: atenúan pero no bloquean. Las costillas quedan registradas con el corazón del atlas y la piel ~1 cm por delante del esternón. Cada línea del sector se traza con atenuación dependiente de la frecuencia, reflexión especular según el ángulo, speckle fijado a la anatomía, sombra de costillas y pulmón, reverberaciones pleurales y la resolución del haz. Para acercarla a un equipo real se añaden heterogeneidad del tejido (agrupación del speckle y bordes irregulares), directividad del elemento, un velo de lóbulos laterales, ruido de campo cercano, reducción de speckle y un mapa de grises con rechazo. El modo armónico (THI, por defecto) se aproxima con sus efectos visibles: menos ruido cercano y lóbulos laterales, haz más estrecho, señal débil junto a la sonda y algo menos de penetración; no se simula la propagación no lineal. El foco de transmisión estrecha el haz a su profundidad. La frecuencia de cuadros se calcula con la profundidad, el sector y la caja de color, y la pantalla solo muestra los cuadros adquiridos. Es una simulación simplificada, sin valores medibles con significado clínico.</p>
