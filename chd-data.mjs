...
export const VARIANTS=[
 ...
 {id:'asd1',name:'CIA tipo ostium primum',short:'CIA OP',group:'Cortocircuitos',params:{radius:.0085},
  ...
  pitfall:'Suele asociarse a hendidura (cleft) de la mitral: busca insuficiencia mitral.',doppler:'Cortocircuito de AI a AD en la porción baja del septo, junto a las válvulas AV.',teach:'Forma parte del espectro del defecto del septo auriculoventricular.'},
